...
class YelpService {
    ...
    lateinit var business: com.rafaeltimbo.appetite.model.Business
    ...
    fun getBusiness(id: String, callback: YelpService.Callback< com.rafaeltimbo.appetite.model.Business >) {
        ...
        val yelpCallback = object : retrofit2.Callback<Business> {
            override fun onResponse(call: Call<Business>?, yelpResponse: Response<Business>?) {
                business = com.rafaeltimbo.appetite.model.Business( yelpResponse?.body()!! )
                printBusiness()
    ...
    fun sync_getBusiness(id: String): Business {
        ...
        business = com.rafaeltimbo.appetite.model.Business( businessResponse.body() )
        printBusiness()
        return businessResponse.body()
    }

    fun getSearchResults(): ArrayList<com.rafaeltimbo.appetite.model.Business> {
        val businessList: ArrayList<com.rafaeltimbo.appetite.model.Business> = ArrayList()
        response.businesses.mapTo(businessList) { com.rafaeltimbo.appetite.model.Business(it) }
        return businessList
    }
